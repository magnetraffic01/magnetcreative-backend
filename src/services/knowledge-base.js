...
const NEGOCIOS = {
  TrebolLife: {
    ...
    storybrand: 'REGLA CRITICA: Los headlines son EJEMPLOS DE REFERENCIA — NUNCA copiarlos textual. Cada creativo debe tener un headline UNICO inspirado en estos temas y dolores. VARIAR siempre el angulo, la emocion y la situacion. BANCO DE HOOKS POR PLAN Y DOLOR: [DENTAL - dolor/miedo/costo] "Cuanto tiempo llevas aguantando ese dolor de muela porque crees que no puedes pagarlo?" / "Tu dentista te dijo $2,500 por una corona. Nosotros: $524." / "$14.99/mes. Toda tu familia. Sin excusas." / "El dolor de muela no espera al lunes. Tu plan dental tampoco." / "76% de descuento en limpieza dental. Sin seguro social." [SAFE - emergencia/telemedicina/familia] "Son las 2AM. Tu hijo tiene fiebre de 103. A donde vas?" / "Consulta medica $0. Desde tu celular. A cualquier hora." / "¿Cuanto pagas por una visita al ER? $400+. Con TreboLife: $0." / "7 personas protegidas. 1 solo pago. Sin SSN." / "Tu familia merece un doctor a un mensaje de distancia." [HEALTH PLUS - cronico/diabetes/hipertension] "Tienes diabetes, hipertension o colesterol. Necesitas un medico que te conozca." / "Tu condicion cronica no toma vacaciones. Tu doctor tampoco." / "Control mensual de diabetes por $29.99. Sin seguro social." / "Un medico que habla tu idioma y entiende tu condicion." [VISION - ninos/escuela] "Tu hijo reprueba. No es que no estudia — es que no puede ver el pizarron." / "Examen de vista para toda la familia. Incluido en tu plan." / "$0 extra por vision. Ya esta en tu membresia." PRINCIPIOS DE COPY PARA ADS: 1) El headline debe generar IDENTIFICACION inmediata (el prospecto dice "eso me pasa a mi"). 2) Usar situaciones REALES y CONCRETAS, no frases genericas. 3) Numeros > palabras ($0, 76%, $14.99, 7 personas). 4) El dolor PRIMERO, la solucion DESPUES. 5) NUNCA saturar: 1 mensaje principal + 1 CTA. No meter 5 beneficios en un ad. 6) CTA directo: "Llama ahora", "Escribe por WhatsApp", "Cotiza gratis" — NUNCA "Conoce mas". Estructura brochure: 13 slides obligatorias (Hero crisis -> Problema 3 niveles -> Servicios -> Beneficio clave -> Farmacia/Diabetes -> Vision/Labs -> Dental ahorro -> 7 personas 1 precio -> Vida transformada 4 antes/despues -> Precios con ancla -> Sin barreras -> 3 pasos sin friccion -> CTA final + disclaimer legal).',
    copy_ads: 'PATRONES PROBADOS EN ADS DE LEADS (extraido de ads reales con mejor rendimiento): LAYOUT EFECTIVO: 1) Numero hero grande (ej: "7" personas, "$0" consulta, "76%" descuento) como anchor visual. 2) Maximo 3 elementos: headline + beneficio + CTA. 3) Fondo limpio (blanco/crema) o fondo contextual (foto de familia hispana borrosa). 4) Iconos > texto para beneficios (dental, vision, farmacia, telemedicina). 5) WhatsApp como CTA principal (boton verde visible). COPY QUE CONVIERTE: "SIN SEGURO SOCIAL" = trigger #1 para inmigrantes. "Consultas medicas $0" = propuesta irresistible. "Cubre hasta 7 personas" = valor familiar. "Activacion inmediata" = elimina barrera de espera. "Sin requisitos especiales" = elimina miedo. ANTI-PATRONES (NO HACER): 1) No poner foto de persona ocupando >30% del espacio en ads de leads (distrae de la oferta). 2) No usar mas de 2 lineas de texto en la imagen (Meta penaliza >20% texto). 3) No usar CTAs vagos ("Mas informacion", "Conoce mas"). 4) No repetir el mismo headline en multiples creativos — SIEMPRE variar. 5) No mezclar 3+ beneficios en un solo ad — elegir UNO y amplificarlo. 6) No usar fondos blancos planos sin profundidad — agregar gradiente sutil o textura.',
  ...
  Traduce: {
    ...
    copy_ads: 'PATRONES PROBADOS EN ADS REALES DE TRADUCE: HEADLINE PRINCIPAL (nunca cambiar el core): "Traducciones Certificadas en 24 Horas" — este es el mensaje central que aparece en TODOS los ads exitosos. ELEMENTOS OBLIGATORIOS en cada ad: 1) Precio ancla: "Desde $13.99/pagina". 2) Trust badge: "100% Aceptacion USCIS" con referencia legal (8 CFR 103.2(b)(3)). 3) CTA WhatsApp: "Cotizacion GRATIS por WhatsApp". BANCO DE HOOKS (variar por angulo): [URGENCIA] "Tu cita con USCIS es en 2 semanas. Tu documento no esta traducido." / "24 horas. Certificado. Aceptado por USCIS. Desde $13.99." [MIEDO/RECHAZO] "Un documento mal traducido puede retrasar tu caso meses." / "100% de nuestras traducciones aceptadas. Cero rechazos." [PRECIO] "Desde $13.99/pagina. Certificada. En 24 horas." / "$13.99 entre tu documento y tu futuro." [PROCESO SIMPLE] "Envia tu documento por WhatsApp. Recibe tu traduccion certificada en 24h." / "3 pasos: envia, cotiza, recibe. Asi de facil." DOS ESTILOS DE AD PROBADOS: ESTILO A (Fondo blanco): limpio, profesional, texto navy/rojo, precio en rojo, WhatsApp verde. Mejor para: primer contacto, audiencia fria. ESTILO B (Fondo oscuro + foto documentos/pasaporte): overlay sobre imagen real de pasaporte/documentos. Mas emocional, conecta con la experiencia migratoria. Mejor para: retargeting, audiencia que ya busco traducciones. ANTI-PATRONES: No hacer ads solo con logo (0 conversion). No omitir el precio (genera desconfianza). No usar CTA que no sea WhatsApp (es el canal #1 de la audiencia hispana). No mezclar espanol e ingles en el mismo ad (elegir uno).',
  ...
  FFL: {
    ...
    copy_ads: 'PATRONES PROBADOS EN ADS DE SALUD/DENTAL: HOOKS QUE FUNCIONAN: "Consultas medicas $0. Sin seguro social." / "Cubre hasta 7 personas de tu familia. 1 solo pago." / "$99/ano. 75,000+ dentistas. Activacion inmediata." / "Limpieza dental: $135 sin plan vs $33 con plan. Tu eliges." / "Seguro para diabeticos. Costo cero." ELEMENTOS VISUALES PROBADOS: Numero hero grande como anchor ("7", "$0", "76%"). Iconos de servicios en fila (dental, vision, farmacia, labs). Fondo oscuro + texto dorado/amarillo = urgencia. Fondo blanco + iconos color = claridad y confianza. Badge "SIN SEGURO SOCIAL" siempre visible. REGLA DE COPY: Elegir UN angulo por ad: precio, familia, emergencia, o ahorro. NO mezclar todos.',
...
async function buildKnowledgeContext(submission, pool) {
  ...
  if (dynamicBusiness) {
    ...
    if (negocio.copy_ads) context += `Patrones de copy para ads: ${negocio.copy_ads}\n`;
